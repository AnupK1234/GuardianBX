...
import cn from "./TailwindMergeAndClsx";
import IconSparkleLoader from "./IconSparkleLoader";
import { OPENAI_API_KEY, SIMLI_API_KEY } from "./keys";
        ...
        {!isAvatarVisible ? (
          ...
          <>
            <div className="flex items-center gap-4 w-full">
              ...
              >
                <span className=" group-hover:text-black font-bold w-[164px] transition-all duration-300">
                  Stop Interaction
                </span>
              </button>
            </div>
